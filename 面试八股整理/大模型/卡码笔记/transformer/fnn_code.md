...
### # 三步流程
 步骤 操作 输入形状 输出形状 ① 升维 x⋅W1+b1x · W_1 + b_1x⋅W1​+b1​ (L,dmodel)(L, d_{model})(L,dmodel​) (L,dff)(L, d_{ff})(L,dff​) ② 激活 ReLU / GELU (L,dff)(L, d_{ff})(L,dff​) (L,dff)(L, d_{ff})(L,dff​) ③ 降维 h⋅W2+b2h · W_2 + b_2h⋅W2​+b2​ (L,dff)(L, d_{ff})(L,dff​) (L,dmodel)(L, d_{model})(L,dmodel​) 
