...
### 整体流程一眼看清
 步骤 操作 输入 输出 ① 线性投影 乘 WQ,WK,WVW_Q, W_K, W_VWQ​,WK​,WV​ n × 512 n × 512（每个） ② 维度拆分 切成 h 份 n × 512 h 个 n × 64 ③ 并行 Attention 每个头独立计算 n × 64 h 个 n × 64 ④ 拼接 Concat h 个 n × 64 n × 512 ⑤ 输出投影 乘 WOW_OWO​ n × 512 n × 512 
