...
### # 知识拓展
 ...
 - **面试官可能的追问1：封装、继承、多态这三大特性之间有何内在联系？** **封装是基础**：它既保护了对象的内部状态，又隐藏了实现细节，为继承提供了安全的基石。没有良好的封装，继承可能导致子类随意破坏父类内部，使得系统脆弱。
 ...
 - **面试官可能的追问2：面向对象设计中，为什么提倡“组合优于继承”？** **继承的强耦合性**：继承是一种“白盒复用”，子类会暴露父类的实现细节，父类内部的修改可能影响所有子类，导致“脆弱的基类问题”。
